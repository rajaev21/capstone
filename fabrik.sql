...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2025 at 08:22 PM
...
(22, 'navy blue', '#0c1b44'),
(23, 'pool green', '#10ba30'),
(24, 'apple green', '#8ec641'),
(25, 'batis', '#394748'),
(26, 'fatigue', '#474743'),
(27, 'dahon', '#7eb844'),
(28, 'emerald green', '#134d5b'),
(29, 'black', '#040809'),
(30, 'gray', '#474747'),
(31, 'pilak', '#7c7e7b'),
(32, 'nomad', '#cab3a3'),
...
--
ALTER TABLE `type`
  MODIFY `type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1063;
