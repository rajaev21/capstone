    ...
    <div className="container mb-4">
      {Array.isArray(details) && details.length > 0 ? (
        <>
          <div className="card mb-4">
            <div className="card-body">
              ...
              <div className="d-flex">
                Print :<span className="ms-auto">{details[0].printPrice}</span>
              </div>
              {details.map((item, index) => {
                if (
                  ["ongoing", "pending", "finished"].includes(item.orderStatus)
                ) {
                  return (
                    <div className="d-flex">
          ...
          <h5>
            Orders
            {["ongoing", "pending"].includes(details[0].transactionStatus) && (
              <button
