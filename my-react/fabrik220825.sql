...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2025 at 02:36 AM
...
(40, 40, 13, 43, 34, 100, 250),
(44, 9, 9, 43, 11, 100, 300),
...
(55, 42, 9, 40, 11, 88, 65),
(56, 42, 9, 41, 11, 70, 52),
(57, 42, 9, 46, 11, 70, 122),
(58, 42, 9, 45, 11, 98, 11),
(59, 41, 9, 43, 12, 1000, 0),
(61, 12, 9, 43, 12, 480, 250),
(62, 9, 9, 47, 13, 1609, 222),
(63, 9, 9, 45, 11, 12, 1),
(64, 9, 9, 43, 13, 12, 100),
(65, 9, 9, 45, 13, 12, 1);
...
(53, 'Add Inventory', 60, 0, 0, '1754974204'),
(54, '14', 14, 45, 40, '1000'),
(55, 'Add Inventory', 61, 0, 0, '1755032004'),
(56, '12', 9, 43, 12, '500'),
(57, '12', 9, 43, 12, '500'),
(58, 'Add Inventory', 62, 0, 0, '1755032984'),
(59, '9', 13, 46, 13, '100'),
(60, '9', 13, 46, 13, '1616'),
(61, '9', 13, 46, 13, '1630'),
(62, 'Add Inventory', 63, 0, 0, '1755634954'),
(63, 'Add Inventory', 64, 0, 0, '1755634954'),
(64, 'Add Inventory', 65, 0, 0, '1755634954'),
(65, '9', 9, 45, 11, '12'),
(66, '9', 9, 43, 13, '12'),
(67, '9', 9, 45, 13, '12');
...
(40, 42, 9, 46, 11, 20, 92, 1, NULL),
(41, 42, 9, 41, 11, 20, 92, 1, NULL),
(42, 42, 9, 46, 11, 10, 93, 1, NULL),
(43, 42, 9, 41, 11, 10, 93, 1, NULL),
(44, 42, 9, 45, 11, 1, 94, 3, NULL),
(45, 14, 14, 45, 40, 30, 95, 3, NULL),
(46, 9, 13, 46, 13, 21, 96, 3, NULL),
(47, 12, 9, 43, 12, 10, 96, 3, NULL),
(48, 42, 9, 45, 11, 1, 96, 3, NULL);
...
(92, 86, 1, 4, '1755187200', '', '1754842466'),
(93, 87, 1, 4, '1755014400', 'aug 13', '1754842516'),
(94, 88, 1, 4, '1755619200', 'aug 20', '1754843673'),
(95, 89, 3, 4, '1755878400', 'test 12', '1754974256'),
(96, 90, 3, 4, '1755705600', '', '1755033982');
...
--
ALTER TABLE `color`
  MODIFY `color_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `customer_detail`
--
ALTER TABLE `customer_detail`
  MODIFY `cd_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `inventory`
  MODIFY `inventory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `transaction_detail`
  MODIFY `td_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
